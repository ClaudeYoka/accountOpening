<div class="user-notification">
    <div class="dropdown">
        <a class="dropdown-toggle no-arrow" href="#" role="button" data-toggle="dropdown">
            ...
            <?php
                $empid = $session_id;
                $count_query = mysqli_query($conn, "SELECT COUNT(*) as count FROM tblnotification WHERE  type= 'chequier_request' ");
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <div class="notification-list mx-h-350 customscroll">
                <ul id="notification-list">
                    <?php
                        $notification_query = mysqli_query($conn, "SELECT * FROM tblnotification WHERE type = 'chequier_request'
