	...
	<div class="main-container">
		<div class="pd-ltr-20">
					...
					<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">En cours Leave</li>
								</ol>
							</nav>
					</div>
				</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">En cours LEVAE</h2>
					</div>
				<div class="pb-20">
						...
						<tbody>
							<tr>
								...
								<?php 
									...
									$status=1;
									$reg_status=0;
									$sql = "SELECT tblleave.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.Phonenumber2,tblemployees.cumulative_days,tblemployees.EmailId,tblemployees.Av_leave,tblemployees.Position,tblleave.LeaveType,tblleave.ToDate,tblleave.FromDate,tblleave.PostingDate,tblleave.RequestedDays,tblleave.DaysOutstand,tblleave.WorkCovered,tblleave.HodRemarks,tblleave.RegRemarks,tblleave.HodDate,tblleave.RegDate,tblleave.num_days from tblleave join tblemployees on tblleave.empid=tblemployees.emp_id where tblleave.HodRemarks = '$reg_status' order by lid desc";
