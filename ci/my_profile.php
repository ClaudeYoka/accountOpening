...
<?php
	if(isset($_POST['new_update']))
	{
		...
		$result = mysqli_query($conn,"UPDATE tblemployees set FirstName='$fname', LastName='$lname', AgenceShortName='$email', EmailId='$email', Gender='$gender', Department='$department' where emp_id='$session_id' ")
					or die(mysqli_error($conn));
			if ($result) {
				echo "<script>alert('Image modifée avec succès);</script>";
		...
		if (isset($_POST["update_image"])) {
			...
			if(!empty($image)){
				...
				echo "<script>alert('Selectionner une Image');</script>";
			}
...
<body>
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<?php
								$query= mysqli_query($conn,"SELECT * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName 
															where emp_id = '$session_id'")or die(mysqli_error($conn));
												...
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Agence</label>
																<select name="agence" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_staff = mysqli_query($conn,"SELECT * from tblemployees Join tblagences where emp_id = '$session_id'")or die(mysqli_error($conn));
																		$row_staff = mysqli_fetch_array($query_staff);
																		
																	?>
																	<option value="<?php echo $row_staff['AgenceShortName']; ?>"><?php echo $row_staff['AgenceName']; ?></option>
																		<?php
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" readonly autocomplete="off">
																	<?php
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<div class="modal-footer justify-content-center">
																	<button class="btn btn-primary" name="new_update" id="new_update" data-toggle="modal">Valider & &nbsp;Modifier</button>
																</div>
															</div>
														</div>
													</div>
	...
	<script type="text/javascript">
		var loader = function(e) {
			...
			let show = "<span>Choisir Image : </span>" + file[0].name;
