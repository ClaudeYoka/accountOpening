                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#viewDetailsModal<?php echo $req['id']; ?>">
                                                            <i class="dw dw-eye"></i> Voir Détails
                                                        </a>
                                                        <a class="dropdown-item" href="#" onclick="generateDeliveryForm(<?php echo $req['id']; ?>)">
                                                            <i class="dw dw-file"></i> Bon de Livraison
                                                        </a>
