			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list dropdown-menu-ecobank">
						<a class="dropdown-item" href="my_profile.php"><i class="dw dw-user1"></i> Profil</a>
						<a class="dropdown-item" href="change_password.php"><i class="dw dw-help"></i> Changer le mot de passe</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item text-danger" href="../logout.php"><i class="dw dw-logout"></i> Déconnexion</a>
					</div>
				</div>
			</div>
