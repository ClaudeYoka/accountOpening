(function() {
    ...
    $(document).ready(function() {
        ...
        var currentOptions = {
            headerBackground: "header-white", // Thème par défaut : barre de navigation blanche
            navigationBackground: "sidebar-light", // Thème par défaut : barre latérale claire
        ...
        // Initialize currentOptions from local storage or set defaults
        var storedOptions = getOptions();
        if (storedOptions != null) {
            currentOptions = storedOptions;

            // Vérification de la valeur de navigationBackground
            if (currentOptions.navigationBackground !== "sidebar-light" && currentOptions.navigationBackground !== "sidebar-dark") {
                currentOptions.navigationBackground = "sidebar-light"; // Réinitialiser à la valeur par défaut
        ...
        // Appliquer la classe de la barre latérale par défaut
        var body = jQuery('body');
        body.removeClass('sidebar-dark').addClass(currentOptions.navigationBackground);
