...
<?php
	if(isset($_POST['new_update']))
	{
		...
		$result = mysqli_query($conn,"UPDATE tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Department='$department' where emp_id='$session_id' ")
