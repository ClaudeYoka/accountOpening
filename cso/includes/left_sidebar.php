				...
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="index" class="dropdown-toggle no-arrow">
							<span class="micon fa fa-th-large"></span><span class="mtext">Dashboard</span>
						</a>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="account_part">Personne Morale</a></li>
						</ul>
					</li>
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle no-arrow" data-toggle="modal" data-target="#documentsModal">
							<span class="micon fi-print"></span><span class="mtext">Documents</span>
						</a>
					</li>
					...
					<!-- <li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="tracking_history">Compte</li>
						</ul>
					</li> -->
